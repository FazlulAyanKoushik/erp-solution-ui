...
@Component({
  selector: 'app-courier-payment',
  templateUrl: './courier-payment.component.html',
  styleUrls: ['./courier-payment.component.scss']
})
export class CourierPaymentComponent implements OnInit {
   ...
   ngOnInit(): void {
     ...
     this.reloadService.refreshBlogs$
       .subscribe(() => {
         this.getAllBlogs();
       });
